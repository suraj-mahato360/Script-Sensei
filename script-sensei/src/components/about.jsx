...
// ];
const stats = [
  { name: "Genres", value: "10" },
  { name: "Types", value: "3" },
  { name: "Audience", value: "5" },
  { name: "Output Length", value: "Unlimited" },
];
...
export default function About() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      >
        <div
          className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r opacity-20"
          style={{
            clipPath:
